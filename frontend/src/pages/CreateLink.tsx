...
export default function CreateLink() {
  ...
  const { register, handleSubmit, control, formState: { errors } } = useForm<CreateAccessLink>({
    defaultValues: {
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
          ...
          <div className="space-y-5">
              ...
              <div className="relative">
                <input
                  {...register('name', {
                    ...
                    pattern: {
                      value: /^[a-zA-Z0-9\s\-.,&]+$/,
                      message: 'Link name can only contain letters, numbers, spaces, and basic punctuation (- . , &)'
                    }
                  })}
                  type="text"
                  ...
                  } px-3 py-2.5 shadow-sm placeholder-gray-400 focus:outline-none focus:ring-1 sm:text-sm`}
            ...
            <div>
              <label htmlFor="purpose" className="block text-sm font-medium text-gray-700 mb-1">
                <FiTag className="inline mr-1 text-gray-500" />
                Purpose
              </label>
              <Controller
                name="purpose"
            ...
            <div>
              ...
              <textarea
                ...
                rows={4}
                className={`block w-full rounded-md border ${
                  errors.notes ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-primary-500 focus:ring-primary-500'
                } px-3 py-2.5 shadow-sm placeholder-gray-400 focus:outline-none focus:ring-1 sm:text-sm`}
        ...
        <div className="card">
          ...
          <div className="space-y-5">
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
              <div>
                <label htmlFor="active_on" className="block text-sm font-medium text-gray-700 mb-1">
                  <FiCalendar className="inline mr-1 text-gray-500" />
                  Active From
                </label>
                <input
                  {...register('active_on', {
                  ...
                  type="datetime-local"
                  className={`block w-full rounded-md border ${
                    errors.active_on ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-primary-500 focus:ring-primary-500'
              ...
              <div>
                ...
                <input
                  ...
                  type="datetime-local"
                  className={`block w-full rounded-md border ${
                    errors.expiration ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-primary-500 focus:ring-primary-500'
                  } px-3 py-2.5 shadow-sm focus:outline-none focus:ring-1 sm:text-sm`}
                />
                {errors.expiration ? (
            ...
            <div>
              <label htmlFor="max_uses" className="block text-sm font-medium text-gray-700 mb-1">
                <FiHash className="inline mr-1 text-gray-500" />
                Maximum Uses
              </label>
              <input
                {...register('max_uses', {
                ...
                max="1000"
                className={`block w-full rounded-md border ${
                  errors.max_uses ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-primary-500 focus:ring-primary-500'
                } px-3 py-2.5 shadow-sm placeholder-gray-400 focus:outline-none focus:ring-1 sm:text-sm`}
        ...
        <div className="flex justify-end space-x-3">
          <button
            ...
            className="rounded-md border border-gray-300 bg-white px-5 py-2.5 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 transition-colors"
          >
            Cancel
          </button>
          <button
